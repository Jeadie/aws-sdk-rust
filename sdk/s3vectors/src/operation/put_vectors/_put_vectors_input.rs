...
impl PutVectorsInputBuilder {
    ...
    pub fn set_vectors(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<crate::types::PutInputVector>>,
    ) -> Self {
        self.vectors = input;
        self
    }
    ...
    pub fn get_vectors(
        &self,
    ) -> &::std::option::Option<::std::vec::Vec<crate::types::PutInputVector>> {
        &self.vectors
    }
    ...
    pub fn build(
        ...
        crate::operation::put_vectors::PutVectorsInput,
