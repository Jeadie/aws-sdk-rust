...
impl PutVectorBucketPolicyInput {
    ...
    pub fn builder(
    ) -> crate::operation::put_vector_bucket_policy::builders::PutVectorBucketPolicyInputBuilder
    {
...
impl PutVectorBucketPolicyInputBuilder {
    ...
    pub fn build(
        ...
        crate::operation::put_vector_bucket_policy::PutVectorBucketPolicyInput,
